...
class Customers(models.Model):
    ...
    supportrep = models.ForeignKey('Employees', models.DO_NOTHING, related_name='customer', db_column='SupportRepId', blank=True, null=True)  # Field name made lowercase.
...
class InvoiceItems(models.Model):
    ...
    invoice = models.ForeignKey('Invoices', models.DO_NOTHING, db_column='InvoiceId')  # Field name made lowercase.
    track = models.ForeignKey('Tracks', models.DO_NOTHING, db_column='TrackId')  # Field name made lowercase.
...
class Invoices(models.Model):
    ...
    customer = models.ForeignKey(Customers, models.DO_NOTHING, db_column='CustomerId')  # Field name made lowercase.
...
class PlaylistTrack(models.Model):
    ...
    track = models.ForeignKey('Tracks', models.DO_NOTHING, related_name='track', db_column='TrackId')  # Field name made lowercase.
...
class Tracks(models.Model):
    ...
    album = models.ForeignKey(Albums, models.DO_NOTHING, related_name='tracks', db_column='AlbumId', blank=True, null=True)  # Field name made lowercase.
    mediatype = models.ForeignKey(MediaTypes, models.DO_NOTHING, related_name='tracks', db_column='MediaTypeId')  # Field name made lowercase.
    genre = models.ForeignKey(Genres, models.DO_NOTHING, related_name='tracks', db_column='GenreId', blank=True, null=True)  # Field name made lowercase.
